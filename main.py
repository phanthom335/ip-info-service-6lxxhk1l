    """
    Ip Info Service 6lxxhk1l
    ========================
    Open-source API service that throttles data between clients and backends.
    ...
    APP_NAME    = "Ip Info Service 6lxxhk1l"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that throttles data between clients and backends.")
